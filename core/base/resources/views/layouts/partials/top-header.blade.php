...
<div class="page-header-top navbar navbar-inverse" role="navigation" xmlns="http://www.w3.org/1999/html">
    <div class="navbar-header page-logo">
        ...
        <a class="navbar-brand" href="{{ route('dashboard.index') }}">
            @if (setting('admin_logo'))
                <img src="{{ url(setting('admin_logo', config('core.base.general.logo'))) }}" alt="logo" class="logo-default" style="max-width: 60px; padding: 10px"/>
            @else
                <span>Bot</span>ble
            @endif
        </a>
    ...
    <div class="top-menu">
        <ul class="nav navbar-nav float-right collapse">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle dropdown-header-name" style="padding-right: 10px" href="{{ route('public.index') }}" target="_blank"><i class="fa fa-globe"></i> <span class="d-none d-sm-inline">{{ __('View website') }}</span> </a>
            </li>
